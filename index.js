    ...
    async (req, res) => {
      ...
      try {
        const venomOptions = {
          ...
          createFileToken: true //creates a folder when inserting an object in the client's browser, to work it is necessary to pass the parameters in the function create browserSessionToken
        };
